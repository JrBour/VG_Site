...
function make_site_theme_from_oldschool($theme_name, $template) {
	 ...
	 */
	$files = array('index.php' => 'index.php', 'wp-layout.css' => 'styless.css', 'wp-comments.php' => 'comments.php', 'wp-comments-popup.php' => 'comments-popup.php');
	...
	$stylelines = file_get_contents("$site_dir/styless.css");
	if ($stylelines) {
		$f = fopen("$site_dir/styless.css", 'w');
...
function make_site_theme_from_default($theme_name, $template) {
	...
	//$files = array('index.php', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'styless.css');
	...
	$stylelines = explode("\n", implode('', file("$site_dir/styless.css")));
	if ($stylelines) {
		$f = fopen("$site_dir/styless.css", 'w');
